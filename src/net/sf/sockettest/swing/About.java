...
public class About extends JPanel /*JFrame*/ {
    ...
    private JLabel version = new JLabel(html+": 3.1", JLabel.LEFT);
    ...
    private JLabel editorText = new JLabel(html+"Editores",ball,JLabel.LEFT);
    private JLabel editor = new JLabel(html+": Miquéias Fernandes, Rafael Felix, Valquíria Anacleto", JLabel.LEFT);
    ...
    public About() {
        ...
        gbc.gridx = 0;
        gbc.weightx = 0.0;
        topPanel.add(editorText, gbc);
        gbc.gridx = 1;
        topPanel.add(editor, gbc);
        gbc.gridx = 2;
        gbc.weightx = 1.0;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        topPanel.add(Box.createHorizontalGlue(), gbc);
